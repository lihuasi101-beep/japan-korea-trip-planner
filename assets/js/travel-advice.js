(function () {
  const advice = {
    ...
    tsushima: {
      title: '对马岛｜严原直达优先，住严原一晚',
      stay: '优先釜山直达严原，住严原港附近 1 晚；9/28 抵达后在严原周边活动，9/29 从严原港去福冈。',
      transport: '釜山 → 严原直达船优先，航程通常约 2 小时；若当天无直达班次，再改为釜山 → 比田胜后包车/出租车前往严原。严原 → 博多。',
      plan: '9/28 抵达严原后安排万松院、对马博物馆、对马神社等近港景点；9/29 从严原港乘船去福冈，具体以船班为准。'
    },
    fukuoka: {
      title: '福冈｜博多站作为主基地',
