(function (global) {
  const itinerary = [
    ...
    ['day-04-am','9/28','周一','对马岛','对马岛北部／比田胜周边','上午','全天慢游 · 以租车或巴士条件调整'],
    ['day-04-pm','9/28','周一','对马岛','比田胜周边海岸、神社与自由活动','下午','南部景点需租车长途移动，暂不硬排'],
    ['day-05-am','9/29','周二','福冈','对马岛→博多港→福冈酒店','上午','客轮转场 · 预留入境与行李时间'],
    ['day-05-pm','9/29','周二','福冈','栉田神社、博多','下午','抵达后轻量游览'],
    ['day-06-am','9/30','周三','福冈','太宰府天满宫','上午','半日游'],
    ['day-06-pm','9/30','周三','福冈','福冈塔、百道海滨','下午','傍晚观景'],
    ['day-07-am','10/1','周四','福冈','大濠公园、福冈城遗址','上午','公园与历史遗址'],
    ['day-07-pm-1','10/1','周四','福冈','LaLaport福冈、实物大ν高达','下午','下午入场'],
    ['day-07-pm-2','10/1','周四','福冈','GUNDAM SIDE-F、LaLaport购物','下午','高达主题店与购物'],
    ['day-07-night','10/1','周四','福冈','ν高达夜间演出','晚上','演出时间出发前复核'],
    ['day-08-am','10/2','周五','熊本','福冈→熊本','上午','新干线转场、酒店寄存'],
    ['day-08-pm-1','10/2','周五','熊本','熊本城、城彩苑','下午','城郭与文化商业'],
    ['day-08-pm-2','10/2','周五','熊本','熊本熊广场、熊本市中心','下午','舞台时间出发前查询'],
    ['day-09-am','10/3','周六','熊本','水前寺成趣园','上午','庭园慢游'],
    ['day-09-pm','10/3','周六','熊本','阿苏一日：草千里、中岳火口','下午','火口开放与交通需复核'],
    ['day-10-am','10/4','周日','熊本','阿苏神社或火山博物馆','上午','阿苏替代线路'],
    ['day-10-pm','10/4','周日','熊本','机场交通确认、行李整理','下午','建议住机场交通方便处'],
